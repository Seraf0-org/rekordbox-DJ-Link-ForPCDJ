...
test("release workflow seals the exact v1.1.8 tag, artifacts, and compiler before upload", () => {
  ...
  assert.match(RELEASE_WORKFLOW, /\$expectedTag = "v1\.1\.8"/);
  ...
  assert.match(RELEASE_WORKFLOW, /dist\/rb-output-1\.1\.8\.zip/);
