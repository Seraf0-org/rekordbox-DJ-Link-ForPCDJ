...
function buildProbeScenarioScript(helperPath, rootPath) {
  ...
  return [
    ...
    `if (`,
    `  $metadata.ProductVersion -cne '1.1.5' -or`,
    ...
    `}`,
    ``,
    `$withStderr = Invoke-NodePackagingProbeProcess -ProjectRoot '${rootLiteral}' -ProbeSource 'process.stdout.write("1.1.5|6.22.0|6.22.0|6.22.0"); process.stderr.write("benign warning");' -TimeoutMs 5000`,
    `if ($withStderr.ExitCode -ne 0 -or $withStderr.Stdout -cne "1.1.5|6.22.0|6.22.0|6.22.0" -or $withStderr.Stderr -cne "benign warning") {`,
    ...
    ``,
    `$malformedCases = @(`,
    `  @{ Name = "malformed field count"; Output = "1.1.5|6.22.0|6.22.0"; Pattern = "invalid field count" },`,
    `  @{ Name = "missing pin"; Output = "1.1.5||6.22.0|6.22.0"; Pattern = "invalid field" },`,
    `  @{ Name = "wrong pin"; Output = "1.1.5|6.22.1|6.22.0|6.22.0"; Pattern = "must be exactly" },`,
    `  @{ Name = "newline field"; Output = "1.1.5\`n|6.22.0|6.22.0|6.22.0"; Pattern = "invalid field" }`,
    `)`,
