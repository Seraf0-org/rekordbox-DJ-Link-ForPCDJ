...
& npx --yes @yao-pkg/pkg@6.22.0 server/index.js --targets node22-win-x64 --output dist\server.exe
...
if (Test-Path $iscc) {
  ...
  Write-Host "For a proper installer, install Inno Setup 6 from https://jrsoftware.org/isdl.php"
}
